...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 10; // 10 days
...
const string strMessageMagic = "nope Signed Message:\n";
...
// nope: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nope", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Nope Nope Nope 10.17.2014";
        CTransaction txNew;
        txNew.nTime = 1413598777;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb892abf238ae43df35a220383844479bbfaef68b1b26d1f509a95f5022245bc3"));
        block.print();
